...
/******************* percol_surface() *******************/
/** Calculates surface of the largest cluster **/
/** ’id_largest’ **/
/** PARAMETERS: (*)= return-paramter **/
/** 	num_n: number of neighbours **/
/** 	N: number of sites **/
...
/** 	id_largest: id of largest cluster **/
/** RETURNS: **/
/** 	size of surface of largest cluster **/
/********************************************************/

int percol_surface(int num_n, int N, int *next, int num_cl, int *cluster, int id_largest)
{
	int t, r;
	int surface;
	int neighbour;
